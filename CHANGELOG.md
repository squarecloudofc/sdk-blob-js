...
- Audit documentation links (all verified live) and update the release workflow to current GitHub Actions versions (checkout v7, setup-node v6, pnpm/action-setup v6, Node 22).
